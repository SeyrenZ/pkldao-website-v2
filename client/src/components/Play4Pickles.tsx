        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              {/* Floating Elements */}
              <FloatingElement className="-top-4 sm:right-16 right-0 w-16 h-16 bg-pkl-yellow rounded-2xl flex items-center justify-center shadow-lg">
                <i className="fas fa-table-tennis-paddle-ball text-pkl-green text-xl"></i>
              </FloatingElement>
              <FloatingElement
                className="-bottom-4 sm:left-16 w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-lg"
